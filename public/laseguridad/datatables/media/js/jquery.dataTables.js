...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * the page number, so if you have 10 Registros por pagina and want to start on
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Listando del _START_ al _END_ de _TOTAL_ registros
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfo": "Listando del _START_ al _END_ de _TOTAL_ registros",
