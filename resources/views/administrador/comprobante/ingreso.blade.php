    ...
    <div class="col-md-12" id="muestra">
        ...
        <div class="box box-default">
            ...
            <div class="box-body table-responsive no-padding">
                {!! Form::open(array('url'=>'print_comprobante_ingreso', 'method' => 'post', 'id' => 'formulario','enctype'=>'multipart/form-data'))!!}
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            Recibido De: <input type="text" class="form form-control" name="recibido_de"><br>
                            <input type="text" class="form form-control" name="otro">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="5">La Suma De: <input type="text" class="form form-control" name="la_suma_de"></td>
                    </tr>
                    <tr>
