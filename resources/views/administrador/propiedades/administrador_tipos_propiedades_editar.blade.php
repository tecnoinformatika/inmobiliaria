...
<section class="content">
    ...
    {!! Form::open(array('url' => 'propiedades/tipo_propiedad/editar_tipo_propiedad', 'method' => 'post', 'id' => 'formulario')) !!}
    <!-- SELECT2 EXAMPLE -->
    ...
    <div class="box box-default">
        ...
        <div class="box-footer">
            ...
            <a href="{{URL::to('propiedades/crear')}}" class="btn btn-danger" id="cancelar"><i class="fa fa-close"></i> Cancelar</a>
            <button type="button" class="btn btn-success pull-right" onclick="validar()" id="crear"><i class="fa fa-check"></i> Actualizar</button>
        </div>
        {!! Form::close() !!}
    </div>
    <!-- /.box -->
