        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ¿Está segur@ que desea cambiar el estado de la propuedad a <b>Vendida</b><strong
                        id="user"></strong>?
                    <input type="hidden" id="id_p" name="id_p">

                    <div class='checkbox'>
                        <label>
                            <input type='checkbox' value="vender" name='acepta_vender' id="acepta_vender"
                                   onclick="aceptaVender()"> Acepta realizar el
                            procedimiento.
                        </label>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" disabled id="submit_vender"><i
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="div_imagen_principal">
                                    ...
                                    <input type="date" class="form-control" placeholder="Seleccione la fehca..." id="fecha_inicio" name="fecha_inicio" disabled="true">
                                    <span class="help-block" id="error_imagen_principal"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="div_imagen_principal">
                                    ...
                                    <input type="date" class="form-control" placeholder="Seleccione la fehca..." id="fecha_fin" name="fecha_fin" disabled="true">
                                    <span class="help-block" id="error_imagen_principal"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="div_imagen_principal">
                                    ...
                                    <input type="date" class="form-control" placeholder="Seleccione la fehca..." id="fecha_limite" name="fecha_limite" disabled="true">
                                    <span class="help-block" id="error_imagen_principal"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" id="div_imagen_principal">
                                    ...
                                    <input type="text" class="form-control" placeholder="DEstino del inmueble..." id="destino_inmueble" name="destino_inmueble" disabled="true">
                                    <span class="help-block" id="error_imagen_principal"></span>
                                </div>
                            </div>
                        </div>
