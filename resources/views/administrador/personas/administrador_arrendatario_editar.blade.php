...
<section class="content-header">
    <h1>
        Editar Información de Arrendatario en el Sistema
...
<section class="content">
    ...
    {!! Form::open(array('url' => 'personas/arrendatario/editar_arrendatario', 'method' => 'post', 'id' => 'formulario')) !!}
    <!-- SELECT2 EXAMPLE -->
    <input type="hidden" name="id_p" value="{{$p_id}}">
    <input type="hidden" name="id_a" value="{{$a_id}}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group" id="div_ingreso_mensual">
                        ...
                        <input type="number" class="form-control" placeholder="Digite el ingreso mensual..." id="ingreso_mensual" name="ingreso_mensual" step="any" min='0' value="{{$a_ingreso_mensual}}">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="div_numero_registro_camara_comercio">
                        ...
                        <input type="text" class="form-control" placeholder="Digite el número de la cámara de comercio..." id="numero_registro_camara_comercio" name="numero_registro_camara_comercio" value="{{$a_numero_registro_camara_comercio}}">
                ...
                <div class="col-md-12">
                    <div class="form-group" id="div_referencia_bancaria">
                        ...
                        <input type="text" class="form-control" placeholder="Digite el número de la referencia bancaria..." id="referencia_bancaria" name="referencia_bancaria" value="{{$a_referencia_bancaria}}">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="div_cuenta_corriente">
                        ...
                        <input type="text" class="form-control" placeholder="Digite el número de la cuenta corriente..." id="cuenta_corriente" name="cuenta_corriente" value="{{$a_cuenta_corriente}}">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="div_cuenta_ahorroros">
                        ...
                        <input type="text" class="form-control" placeholder="Digite el número de la cuenta de ahorros..." id="cuenta_ahorroros" name="cuenta_ahorroros" value="{{$a_cuenta_ahorroros}}">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="div_referencia_comercial"> 
                        ...
                        <input type="text" class="form-control" placeholder="Digite la referencia comercial..." id="referencia_comercial" name="referencia_comercial" value="{{$a_referencia_comercial}}">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="div_telefono_ref_comercial">
                        ...
                        <input type="tel" class="form-control" placeholder="Digite la referencia comercial..." id="telefono_ref_comercial" name="telefono_ref_comercial" value="{{$a_telefono_ref_comercial}}">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="div_referencia_personal">
                        ...
                        <input type="text" class="form-control" placeholder="Digite la referencia comercial..." id="referencia_personal" name="referencia_personal" value="{{$a_referencia_personal}}">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="div_telefono_ref_personal">
                        ...
                        <input type="tel" class="form-control" placeholder="Digite la referencia comercial..." id="telefono_ref_personal" name="telefono_ref_personal" value="{{$a_telefono_ref_personal}}">
