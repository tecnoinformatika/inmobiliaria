                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" id="div_numero_registro_camara_comercio">
                            ...
                            <input type="text" class="form-control"
                                   placeholder="Digite el número de la cámara de comercio..." id="cargo" name="cargo" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" id="div_finca_raiz_direccion">
                            ...
                            <input type="tel" class="form-control" placeholder="Digite la finca raiz..."
                                   id="finca_raiz_direccion" name="finca_raiz_direccion" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" id="div_matricula_inmobiliaria">
                            ...
                            <input type="tel" class="form-control" placeholder="Digite la finca raiz..."
                                   id="matricula_inmobiliaria" name="matricula_inmobiliaria" readonly>
    ...
    <script>
            ...
            if (nit) {
                ...
                $.ajax({
                    ...
                    if (data == 1) {
                        ...
                        $("#finca_raiz_direccion").removeAttr('readonly');
                        $("#matricula_inmobiliaria").removeAttr('readonly');
        ...
        function reiniciar() {
            if (confirm("¿Está segur@ que desea reinciar los campos del formulario? Si se realiza este proceso se perderán los datos diligenciados en el formulario.")) {
                ...
                $("#finca_raiz_direccion").attr({readonly: "true"});
                $("#finca_raiz_direccion").val("");
                $("#matricula_inmobiliaria").attr({readonly: "true"});
                $("#matricula_inmobiliaria").val("");
            }
        }
